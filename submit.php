...
<!-- Optional crib file:
      ...
      <label for="file-upload"><input type="file" id="crib-upload" name="uploadedCrib"></label> -->
...
print "<h2>GPU status</h2><pre>".`sudo nvidia-smi --query-gpu=gpu_name,temperature.gpu,power.draw,utilization.gpu  --format=csv`."</pre>";
?>
</body>
</html>
